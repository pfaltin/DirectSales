...
namespace DirectSales04.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClientId,Title,OIB,Email,Phone,Remarks,Street,City,Country,PostalCode")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClientId,Title,OIB,Email,Phone,Remarks,Street,City,Country,PostalCode")] Client client)
        {
